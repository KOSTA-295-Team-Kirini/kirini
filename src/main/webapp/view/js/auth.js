const Auth = {
  ...
  // 권한 확인 메소드
  isGuest: function() { return this.getCurrentRole() === this.ROLES.GUEST; },
  isUser: function() { return this.isLoggedIn(); }, // 로그인한 모든 사용자
  isRegularUser: function() { return this.getCurrentRole() === this.ROLES.USER; }, // 일반 사용자(매니저, 관리자 제외)
  isManager: function() { return this.getCurrentRole() === this.ROLES.MANAGER; },
  isAdmin: function() { return this.getCurrentRole() === this.ROLES.ADMIN; },
